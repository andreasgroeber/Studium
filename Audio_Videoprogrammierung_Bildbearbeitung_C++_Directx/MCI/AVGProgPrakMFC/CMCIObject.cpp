...
bool CMCIObject::GetTrackLength(BYTE track, BYTE& min, BYTE& sek, BYTE& frame) /*--------------------logik sollte stimmen --> Return-Wert Berechnung Nicht !!! -----------------------------*/
{
	...
	/* Code für Prozentualle anzeige [Ansatz]
	Get track length(Params)
	Status/Format abfragen
	Switch für ms und msf
	---> Sekunden umrechnen
	--> Prozente umrechnen
